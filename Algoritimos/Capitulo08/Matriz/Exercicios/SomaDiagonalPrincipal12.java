...
public class SomaDiagonalPrincipal12 {
    /**
     * k)Elaborar um programa que leia uma matriz A do 
     * tipo real de duas dimensões com cinco linhas e cinco 
     * colunas. Apresentar o somatório dos elementos situados 
     * na diagonal principal (posições A[1,1], A[2,2], A[3,3], 
     * A[4,4] e A[5,5]) da referida matriz. 

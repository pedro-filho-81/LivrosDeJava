...
public class Student 
{
   ...
   // cria o construtor da classe Student
   // constructor initializes instance variables
   public Student(String name, double average)
   {
      // atribui o parâmetro nome avariável de instância nome
      this.name = name;

      // validate that average is > 0.0 and <= 100.0; otherwise,
      // keep instance variable average's default value (0.0)
      // condição se média for maior que 0.0 zero
      if (average > 0.0) 
         // e se média for menor que ou igual a 100.0
         if (average <= 100.0)
            // atribui o pamâmetro média a variável de instância média
            this.average = average; // assign to instance variable
   } // fim construtor

   // sets the Student's name
   // método para configurar a variável de instância

...
public class Fibonacci29 {
     ...
     * a propriedade de que cada termo sucessivo é a soma dos dois termos precedentes.
     * a) Escreva um método fibonacci(n) que calcule o enésimo número de Fibonacci. 
     * Incorpore esse método a um aplicativo que permita ao usuário inserir o valor de n.
     * b) Determine o maior número de Fibonacci que pode ser exibido em seu sistema.
     * c) Modifique o aplicativo que você escreveu na parte (a) para utilizar double em vez 
     * de int para calcular e retornar números de Fibonacci e utilizar esse aplicativo 
